...
const InputField = memo(({ label, type = "text", name, value, onChange, disabled, isTextarea = false }) => {
  ...
  const inputClasses = `w-full bg-transparent border-b border-border focus:border-accent outline-none py-3 font-sans text-body text-foreground transition-colors duration-300 resize-none ${
...
// Social link card - compact for mobile
  ...
  >
    <div className="flex items-center gap-2 sm:gap-3 min-w-0 flex-1">
      ...
      <div className="min-w-0 flex-1">
        ...
        <p className="font-sans text-micro sm:text-caption text-foreground-muted truncate">{username}</p>
      </div>
    </div>
    <ArrowUpRight className="w-3 h-3 sm:w-4 sm:h-4 flex-shrink-0 ml-2 text-foreground-muted group-hover:text-accent transition-colors duration-300" />
  </motion.a>
));
...
const ContactPage = () => {
  ...
  return (
    <section className="relative py-16 sm:py-section bg-background overflow-x-hidden" id="Contact">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div ref={headerRef} className="mb-10 sm:mb-16">
          ...
          >
            <span className="font-mono text-caption uppercase tracking-[0.2em] sm:tracking-[0.3em] text-accent">
              03
            </span>
            <div className="w-8 sm:w-12 h-px bg-accent" />
            <span className="font-mono text-caption uppercase tracking-[0.2em] sm:tracking-[0.3em] text-foreground-muted">
              Contact
            </span>
          </motion.div>
          <motion.h2
        ...
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-16">
          ...
          >
            ...
            {/* Social links */}
            <div className="mt-10 sm:mt-16 pt-8 sm:pt-16 border-t border-border">
