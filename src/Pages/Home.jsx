...
const WORDS = ["Problem Solver", "Tech Enthusiast", "Creative Coder", "Lifelong Learner"];
...
const SOCIAL_LINKS = [
  ...
  { icon: Instagram, link: "https://www.instagram.com/kelvin.exe__?igsh=ZXBmdjluaHh3ZGxm&utm_source=qr" }
];
            ...
            <div className="w-full lg:w-1/2 space-y-6 sm:space-y-8 text-left lg:text-left order-1 lg:order-1 lg:mt-0"
              ...
              <div className="space-y-4 sm:space-y-6">
                ...
                <p className="text-base md:text-lg text-gray-400 max-w-xl leading-relaxed font-light"
                  data-aos="fade-up"
                  data-aos-delay="1000">
                 Crafting Innovative, Functional, and User-Centric Applications to Solve Real-World Problems and Inspire Digital Growth.
                </p>
